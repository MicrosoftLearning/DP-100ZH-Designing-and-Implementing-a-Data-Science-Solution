...
数据集提供了一种封装数据以进行试验和训练的方法。可以使用表格和文件数据集来定义易于在试验中使用的版本化数据源。
...
3. 在 Jupyter 主页的 **Users/DP100** 文件夹中，打开 **04B - Working with Datasets.ipynb** 笔记本。然后阅读笔记本中的笔记，依次运行每个代码单元。
