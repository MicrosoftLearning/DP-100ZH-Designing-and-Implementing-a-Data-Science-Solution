# 实验 10A：使用 Application Insights 监视模型
...
## 任务 1：使用 Application Insights 监视模型

在此任务中，你将模型部署为服务，并使用 Azure Application Insights 对其进行监视。
...
3. 在 Jupyter 主页的 **Users/DP100** 文件夹中，打开 **10A - Monitoring a Model.ipynb** 笔记本。然后阅读笔记本中的笔记，依次运行每个代码单元。
