...
数据中随时间变化的趋势可能降低模型预测结果的准确性。监视此*数据偏移*，并在必要时进行重新训练，是确保机器学习解决方案继续准确预测的重要方法。
...
3. 在 Jupyter 主页的 **Users/DP100** 文件夹中，打开 **10B - Monitoring Data Drift.ipynb** 笔记本。然后阅读笔记本中的笔记，依次运行每个代码单元。
