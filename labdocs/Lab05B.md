...
虽然可以在本地计算机上运行试验，但在许多情况下，最好利用云计算来增强可缩放性。
...
3. 在 Jupyter 主页的 **Users/DP100** 文件夹中，打开 **05B - Working with Compute Targets.ipynb** 笔记本。然后阅读笔记本中的笔记，依次运行每个代码单元。
